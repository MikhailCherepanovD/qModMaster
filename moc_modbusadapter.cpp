...
#include <memory>
#include "../QModMaster/src/modbusadapter.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModbusAdapter_t, stringdata0) + ofs \
...
void ModbusAdapter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ModbusAdapter *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ModbusAdapter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModbusAdapter::refreshView)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ModbusAdapter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ModbusAdapter.data,
    qt_meta_data_ModbusAdapter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ModbusAdapter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ModbusAdapter.stringdata0))
