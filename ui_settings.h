...
public:
    ...
    void setupUi(QDialog *Settings)
    {
        ...
        Settings->resize(220, 150);
        QSizePolicy sizePolicy(QSizePolicy::Maximum, QSizePolicy::Maximum);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(Settings->sizePolicy().hasHeightForWidth());
        Settings->setSizePolicy(sizePolicy);
        Settings->setMinimumSize(QSize(220, 150));
        ...
        lblEndian = new QLabel(Settings);
        lblEndian->setObjectName(QString::fromUtf8("lblEndian"));

        gridLayout->addWidget(lblEndian, 3, 1, 1, 1);

        cmbEndian = new QComboBox(Settings);
        cmbEndian->addItem(QString());
        cmbEndian->addItem(QString());
        cmbEndian->setObjectName(QString::fromUtf8("cmbEndian"));

        gridLayout->addWidget(cmbEndian, 3, 2, 1, 1);
    ...
    void retranslateUi(QDialog *Settings)
    {
        ...
        lblBaseAddr->setText(QCoreApplication::translate("Settings", "Base Addr", nullptr));
        lblMaxNoOfRawDataLines->setText(QCoreApplication::translate("Settings", "Max No Of Bus Monitor Lines", nullptr));
        lblTimeout->setText(QCoreApplication::translate("Settings", "Response Timeout (sec)", nullptr));
        lblEndian->setText(QCoreApplication::translate("Settings", "Endian", nullptr));
        cmbEndian->setItemText(0, QCoreApplication::translate("Settings", "Little", nullptr));
        cmbEndian->setItemText(1, QCoreApplication::translate("Settings", "Big", nullptr));
